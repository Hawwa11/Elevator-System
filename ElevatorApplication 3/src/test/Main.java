...
public class Main extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        //</editor-fold>
         ...
         ThreadAll Mthree= new ThreadAll(mainM,t3);
...
//System.exit(0); //exits the system code if u uncomment Main then need to comment this as well.
    ...
    //method to generate random users for 3 elevators
  public static void createUsers ()
    {
       Random rand = new Random();
            ...
            int AllGetOn;
            int AllGetoff;
            Passenger[] usersEven = new Passenger[5];
            Passenger[] usersOdd = new Passenger[5];
            Passenger[] usersAll= new Passenger[5];
       ...
       StringBuilder sb3 = new StringBuilder();
        ...
        for(int i=0; i<5; i++)
        {
            ...
            usersEven[i] = new Passenger(i, weight, fGetOn, fGetOff);
            ...
            usersOdd[i] = new Passenger(i+5, weight, fGetOn, fGetOff);
            ...
            weight = Math.round((Math.random()*800)*100.0)/100.0;
            AllGetOn = random.nextInt(max-min)+min;
            AllGetoff = random.nextInt(max-min)+min;
            usersAll[i] = new Passenger(i+10, weight, AllGetOn, AllGetoff);
         
                sb3.append("User weights for Elevator three \n \n");
               sb3.append("E3 - User ").append(usersAll[i].userId).append(" weight : ").append(weight).append("\n");
